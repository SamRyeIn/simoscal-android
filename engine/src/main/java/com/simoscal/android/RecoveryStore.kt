...
// Deliberately still "quickedit_recovery" after the 2026-08-20 rename. This is
// an on-disk filename, not a code name: changing it points the app at a fresh,
// empty store and silently orphans the recovery pointer of any session already
// staged on a device. A session interrupted before the rename would come back
// as "nothing to recover", which is the one thing this store exists to prevent.
